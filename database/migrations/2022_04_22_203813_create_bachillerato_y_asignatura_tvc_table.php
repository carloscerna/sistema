...
class CreateBachilleratoYAsignaturaTvcTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bachillerato_y_asignatura_tvc', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bachillerato_y_asignatura_tvc');
    }
}
