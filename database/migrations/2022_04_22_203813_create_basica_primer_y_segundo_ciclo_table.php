...
class CreateBasicaPrimerYSegundoCicloTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('basica_primer_y_segundo_ciclo', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('basica_primer_y_segundo_ciclo');
    }
}
