...
class CreateBachilleratoYAsignaturaContadorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bachillerato_y_asignatura_contador', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bachillerato_y_asignatura_contador');
    }
}
